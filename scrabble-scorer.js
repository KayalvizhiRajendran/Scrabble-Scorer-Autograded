...
let transform = function(oldPointStructure) {
   ...
   newStructure = sortObject(newStructure);
   return newStructure;
}
let scrabbleScorer = function(word, newPointStructure){
      //console.log(oldPointStructure);
      this.newPointStructure = transform(oldPointStructure);
      //console.log(this.newPointStructure);
      let letters = word.toLowerCase().split("");
      let score = 0;
      for (let index = 0; index < letters.length; index++) {
            let element =letters[index];
            console.log("element: "+ this.newPointStructure[element]);
            score = score + this.newPointStructure[element];
      }
      return score;
   }
